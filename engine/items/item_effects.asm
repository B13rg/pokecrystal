...
LoveBallMultiplier:
; This function multiplies catch rate by 8 if mons are of same species, different sex
...
FastBallMultiplier:
; This function multiplies catch rate by 4 if enemy mon is one of the first three in
