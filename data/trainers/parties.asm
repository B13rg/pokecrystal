...
FalknerGroup:
	...
	db  7, PIDGEY,     TACKLE, MUD_SLAP, STEEL_WING, NO_MOVE
	db  9, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, STEEL_WING
	db -1 ; end

	; FALKNER (2)
	db "FALKNER@", TRAINERTYPE_MOVES
	db  47, PIDGEOT,    QUICK_ATTACK, MUD_SLAP, STEEL_WING, WING_ATTACK
	db  49, SCARMORY,   TOXIC, AGILITY, DRILL_PECK, STEEL_WING
	db  49, DODRIO,     TRI_ATTACK, DRILL_PECK, SKULL_BASH, AGILITY
	db  50, PIDGEOT,    FAINT_ATTACK, MUD_SLAP, SKY_ATTACK, STEEL_WING
	db -1 ; end
...
WhitneyGroup:
	...
	; WHITNEY (2)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 48, CLEFABLE,   BELLY_DRUM, RETURN, MOONLIGHT, FIRE_BLAST
	db 50, MILTANK,    ROLLOUT, BODY_SLAM, GROWL, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 16, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, RAZOR_WIND
	db 18, SHUCKLE,    WITHDRAW, CONSTRICT, HEADBUTT, RETURN
	db -1 ; end

	; BUGSY (2)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 44, BUTTERFREE, SWIFT, RAZOR_WIND, MEGA_DRAIN, POISONPOWDER
	db 44, BEEDRILL,   AGILITY, SKULL_BASH, SWORDS_DANCE, PIN_MISSILE
	db 46, SCIZOR,     METAL_CLAW, DOUBLE_TEAM, FURY_CUTTER, RAZOR_WIND
	db 48, SHUCKLE,    WITHDRAW, CONSTRICT, HEADBUTT, RETURN
	db -1 ; end
...
MortyGroup:
	...
	db 46, HAUNTER,    HYPNOSIS, PSYCHIC_M, THIEF, NIGHT_SHADE
	db 46, GENGAR,     THUNDERBOLT, ICE_PUNCH, DESTINY_BOND, DYNAMICPUNCH
	db 48, MISDREAVUS, SPITE, MEAN_LOOK, PERISH_SONG, PSYBEAM
	db -1 ; end
...
PryceGroup:
	...
	db 29, DEWGONG,    HEADBUTT, SLEEP_TALK, ICE_BEAM, REST
	db 31, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

	; PRYCE (2)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 47, DEWGONG,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST	
	db 46, SNEASEL,    BLIZZARD, SCREECH, ICE_PUNCH, FURY_SWIPES
	db 46, PILOSWINE,  ICY_WIND, ROAR, MIST, BLIZZARD
	db 49, DEWGONG,    HEADBUTT, SLEEP_TALK, ICE_BEAM, REST
	db -1 ; end
...
JasmineGroup:
	...
	db 32, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db 35, MAGNETON,   THUNDERBOLT, SWIFT, TRI_ATTACK, THUNDER_WAVE
	db -1 ; end

	; JASMINE (2)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 50, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 50, MAGNETON,   THUNDERBOLT, SUBSTITUTE, HIDDEN_POWER, THUNDER_WAVE
	db 52, STEELIX,    SCREECH, CRUNCH, ROCK_SLIDE, IRON_TAIL
	db 55, MAGNETON,   THUNDERBOLT, SWIFT, TRI_ATTACK, THUNDER_WAVE
	db -1 ; end
...
ChuckGroup:
	...
	; CHUCK (2)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 47, PRIMEAPE,   CROSS_CHOP, ROCK_SLIDE, MEDITATE, COUNTER
	db 50, HITMONTOP,  HI_JUMP_KICK, COUNTER, CURSE, RAPID_SPIN
	db 50, HERACROSS,  MEGAHORN, REST, SLEEP_TALK, EARTHQUAKE
	db 50, POLIWRATH,  BELLY_DRUM, LOVELY_KISS, HYDRO_PUMP, BODY_SLAM
	db -1 ; end
...
ClairGroup:
	...
	; CLAIR (2)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 57, DRAGONITE,  THUNDER_WAVE, SURF, HAZE, DRAGONBREATH
	db 57, DRAGONITE,  THUNDER_WAVE, REFLECT, SLAM, DRAGONBREATH
	db 57, DRAGONITE,  THUNDER_WAVE, ICE_BEAM, THUNDER, DYNAMICPUNCH
	db 60, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DOUBLE_EDGE
	db -1 ; end
...
WillGroup:
	...
	; WILL (2)
	db "WILL@", TRAINERTYPE_MOVES
	db 58, EXEGGUTOR,  STUN_SPORE, GIGA_DRAIN, EXPLOSION, PSYCHIC_M
	db 60, JYNX,       NIGHTMARE, LOVELY_KISS, MEAN_LOOK, BLIZZARD
	db 60, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 61, WOBBUFFET   COUNTER, MIRROR_COAT, DESTINY_BOND, SAFEGUARD
	db 59, STARMIE,    SURF, RAPID_SPIN, RECOVER, PSYCHIC_M
...
BrunoGroup:
	...
	db 62, STEELIX,    BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 62, POLIWRATH,  WATERFALL, EARTHQUAKE, BODY_SLAM, HYDRO_PUMP
	db 64, MACHAMP,    ROCK_SLIDE, CURSE, VITAL_THROW, CROSS_CHOP	
	db -1 ; end
...
KarenGroup:
	...
	; KAREN (2)
	db "KAREN@", TRAINERTYPE_MOVES
	db 62, SNEASEL,    DYNAMICPUNCH, SHADOW_BALL, RETURN, REFLECT
	db 62, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 62, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 63, HOUNDOOM,   SLUDGE_BOMB, FIRE_BLAST, PURSUIT, COUNTER
	db 64, MURKROW,    DRILL_PECK, NIGHT_SHADE, PURSUIT, FAINT_ATTACK
	db 64, UMBREON,    CURSE, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db -1 ; end
...
KogaGroup:
	...
	; KOGA (2)
	db "KOGA@", TRAINERTYPE_MOVES
	db 61, QWILFISH    CURSE, SLUDGE_BOMB, HYDRO_PUMP, SPIKES
	db 60, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, SLUDGE_BOMB
	db 63, VENOMOTH,   SLUDGE_BOMB, CURSE, PSYCHIC_M, TOXIC	
	db 63, FORRETRESS, SPIKES, RAPID_SPIN, EXPLOSION, GIGA_DRAIN
	db 64, CROBAT,     MEAN_LOOK, FLY, CONFUSE_RAY, TOXIC
	db 62, MUK,        FIRE_BLAST, ACID_ARMOR, SLUDGE_BOMB, GIGA_DRAIN
	db -1 ; end
...
ChampionGroup:
	...
	; CHAMPION (2)
	db "LANCE@", TRAINERTYPE_MOVES
	db 72, DRAGONITE,  THUNDER_WAVE, THUNDERBOLT, THUNDER, HYPER_BEAM
	db 68, GYARADOS,   DOUBLE_EDGE, RAIN_DANCE, HYDRO_PUMP, HYPER_BEAM
	db 72, DRAGONITE,  ICY_WIND, ICE_PUNCH, BLIZZARD, HYPER_BEAM
	db 73, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 68, CHARIZARD,  FIRE_BLAST, EARTHQUAKE, SLASH, HYPER_BEAM
	db 75, DRAGONITE,  FIRE_BLAST, FIRE_PUNCH, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	; BROCK (2)
	db "BROCK@", TRAINERTYPE_MOVES
	db 61, RHYDON,     ROAR, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 61, GOLEM,      RAPID_SPIN, EXPLOSION, EARTHQUAKE, FIRE_BLAST
	db 62, OMASTAR,    HAZE, SURF, PROTECT, SPIKE_CANNON
	db 64, STEELIX,    BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 62, KABUTOPS,   SLASH, HYDRO_PUMP, SWORDS_DANCE, GIGA_DRAIN
	db -1 ; end
...
MistyGroup:
	...
	; MISTY (2)
	db "MISTY@", TRAINERTYPE_MOVES
	db 62, GOLDUCK,    HYDRO_PUMP, DISABLE, PSYCH_UP, PSYCHIC_M
	db 62, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 64, LAPRAS,     HYDRO_PUMP, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 64, TOGETIC,    ENCORE, FIRE_BLAST, SAFEGUARD, PSYCHIC_M
	db 63, STARMIE,    SURF, RAPID_SPIN, RECOVER, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	; LT_SURGE (2)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 64, RAICHU,     THUNDER_WAVE, CHARM, ENCORE, THUNDER
	db 60, ELECTRODE,  THUNDER_WAVE, THUNDERBOLT, LIGHT_SCREEN, EXPLOSION
	db 60, MAGNETON,   SUBSTITUTE, THUNDERBOLT, SWIFT, ZAP_CANNON
	db 60, AMPHAROS,   THUNDERBOLT, FIRE_PUNCH, THUNDER_WAVE, DYNAMICPUNCH
	db 66, ELECTABUZZ, CROSS_CHOP, THUNDERPUNCH, PSYCHIC_M, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	; ERIKA (2)
	db "ERIKA@", TRAINERTYPE_MOVES
	db 62, TANGELA,    STUN_SPORE, SLEEP_POWDER, GIGA_DRAIN, SYNTHESIS
	db 61, JUMPLUFF,   REFLECT, ENCORE, STUN_SPORE, LEECH_SEED
	db 66, VICTREEBEL, SLEEP_POWDER, SYNTHESIS, ACID, RAZOR_LEAF
	db 66, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db 68, VENUSAUR,   SYNTHESIS, LEECH_SEED, RAZOR_LEAF, SLEEP_POWDER
	db -1 ; end
...
JanineGroup:
	...
	; JANINE (2)
	db "JANINE@", TRAINERTYPE_MOVES
	db 66, CROBAT,     SCREECH, TOXIC, CONFUSE_RAY, WING_ATTACK
	db 66, WEEZING,    THUNDERBOLT, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 66, ARBOK,      SLUDGE_BOMB, TOXIC, EXPLOSION, GLARE
	db 63, ARIADOS,    SCARY_FACE, TOXIC, STRING_SHOT, NIGHT_SHADE
	db 69, VENOMOTH,   SLEEP_POWDER, DOUBLE_TEAM, SLUDGE_BOMB, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	; SABRINA (2)
	db "SABRINA@", TRAINERTYPE_MOVES
	db 60, ALAKAZAM,   RECOVER, THUNDER_WAVE, PSYCHIC_M, FIRE_PUNCH
	db 58, ESPEON,     SAND_ATTACK, SHADOW_BALL, BATON_PASS, PSYCHIC_M
	db 66, MR__MIME,   THUNDER, REFLECT, BATON_PASS, PSYCHIC_M
	db 54, JYNX,       PSYCHIC_M, BLIZZARD, PERISH_SONG
	db 53, WOBBUFFET,  COUNTER, MIRROR_COAT, DESTINY_BOND, ENCORE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 28, PINECO,     RAPID_SPIN, TAKE_DOWN, PROTECT, HEADBUTT
	db -1 ; end
	...
	db 37, FORRETRESS, RAPID_SPIN, ROLLOUT, PROTECT, HEADBUTT
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 40, VENOMOTH,   GUST, SUPERSONIC, PSYCHIC_M, TOXIC
	db 42, FORRETRESS, RAPID_SPIN, ROLLOUT, PROTECT, SPIKES
	db -1 ; end
...
BlaineGroup:
	...
	; BLAINE (2)
	db "BLAINE@", TRAINERTYPE_MOVES
	db 70, ARCANINE,   FLAMETHROWER, EXTREMESPEED, REST, SLEEP_TALK
	db 70, NINETALES,  HYPNOSIS, TOXIC, ROAR, FIRE_BLAST 
	db 65, MAGCARGO,   CURSE, EARTHQUAKE, FLAMETHROWER, ROCK_SLIDE
	db 65, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CROSS_CHOP
	db 70, RAPIDASH,   HYPNOSIS, FIRE_SPIN, RETURN, FIRE_BLAST
	db -1 ; end
BurglarGroup:
	; BURGLAR (1)
...
RedGroup:
	...
	; RED (2)
	db "RED@", TRAINERTYPE_MOVES
	db 100, PIKACHU,    SING, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 100, ESPEON,     GROWTH, BATON_PASS, SUBSTITUTE, PSYCHIC_M
	db 100, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 100, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 100, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 100, BLASTOISE,  RAIN_DANCE, SURF, BLIZZARD, RAPID_SPIN
	db -1 ; end
...
BlueGroup:
	...
	db 58, BLASTOISE,  BITE, HYDRO_PUMP, WITHDRAW, BLIZZARD
	...
	; BLUE (2)
	db "BLUE@", TRAINERTYPE_MOVES
	db 76, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 74, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 76, RHYDON,     ROAR, CURSE, ROCK_SLIDE, EARTHQUAKE
	db 78, BLASTOISE,  BITE, HYDRO_PUMP, WITHDRAW, BLIZZARD
